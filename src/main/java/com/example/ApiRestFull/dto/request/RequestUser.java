...
public record RequestUser(
        ...
        @Pattern(regexp = "^[a-zA-Z0-9._]+$", message = "Username pode conter apenas letras, números, ponto e underline")
        String username,
        ...
        @Pattern(regexp = "^[A-Za-zÀ-ÿ]+(?:\\s[A-Za-zÀ-ÿ]+)+$", message = "Nome completo deve conter pelo menos nome e sobrenome, sem números")
        String fullName
) {}
